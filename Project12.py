...
class SaglikUygulamasi(QWidget):
    def __init__(self):
        ...
        self.egzersiz_ad_combobox.addItems(["Pilates", "Yoga", "Koşu", "Yüzme", "Bisiklet", "Ağırlık Antrenmanı"])  # Add more exercise types as needed
        ...
        self.egzersiz_sure_combobox.addItems(["5-10 min", "10-15 min", "15-20 min", "20-30 min", "30-45 min", "45-60 min"])  # Add more duration options as needed
        ...
        self.egzersiz_tekrar_combobox.addItems(["1 set", "2 set", "3 set", "4 set", "5 set", "6 set"])  # Add more repetition options as needed
    ...
    def kayit_ekle(self):
        ...
        if ad and soyad and yas and cinsiyet:
            # Perform the necessary database operations to add the new record
